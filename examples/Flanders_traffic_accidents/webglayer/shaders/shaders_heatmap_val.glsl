<script id="heatmap_val_vShader" type="x-shader/x-vertex">
    ...
    <script id="heatmap_val_fShader" type="x-shader/x-fragment">
      ...
      void main() {
     	...
     	if (dist < 0.5 && dist!=0. ) {    
     			float val =  hmval - (pow(dist*2.,grad) * hmval);
     		  	if (selected == 1.){
