...
function GLUtils() {
	...
	this.loadShaders = function() {
		...
		$.get('vl/shaders/shaders_linemap.glsl',
						function(data) {
							$("head").append(data);
						});

		$.get('vl/shaders/shaders_hist.glsl',
						function(data) {
							$("head").append(data);
						});

		$.get('vl/shaders/shaders_float.glsl',
				function(data) {
					$("head").append(data);
				});

		$.get('vl/shaders/shaders_filter_generic.glsl',
						function(data) {
							$("head").append(data);
						});

		$.get('vl/shaders/shaders_filterhist.glsl',
						function(data) {
							$("head").append(data);
						});
